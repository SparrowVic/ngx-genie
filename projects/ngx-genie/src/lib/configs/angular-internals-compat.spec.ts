...
// Explicit `standalone: true` — required on Angular 18 (standalone-by-default is v19+).
@Component({
  standalone: true,
...
@Pipe({name: 'genieProbePipe', standalone: true})
...
@Directive({selector: '[genieProbeDir]', standalone: true})
