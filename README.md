...
This is the **Angular 19** line of GenieOS — built & tested on `@angular/core` 19.2, TypeScript 5.8, and published as `19.0.0-beta.x` from the `support/19.x` branch.
...
* ✅ **Angular 20** – `support/20.x`
* ✅ **Angular 19** – `support/19.x` ← this line
* ✅ **Angular 18** – `support/18.x`

Install the major that matches your app (peer dependency `^19` on this line).
