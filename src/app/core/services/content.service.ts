...
export class ContentService {
  ...
  readonly faqs = computed<FaqItem[]>(() => [
    ...
    { id: 'versions', question: 'Which Angular versions are supported?', answer: 'GenieOS targets the Angular 22 line — its peer dependency is ^22. Older majors stay maintained on long-lived support branches, so Angular 18 through 22 are supported — each published as its own version-tagged release on npm.', tag: 'Compatibility' },
